...
export default function WaterTankItemLine({ className = '', tankName, state = 'green', colorName = 'slate', children}: WaterTankItemProps) {
  const tankColorMap = {
  ...
  return (
    <div className={`border-4 rounded-2xl px-4 py-3 ${tankColorMap[colorName]} ${className}`}>
      <div className={`flex items-center pb-3 mb-3 justify-between border-b ${borderColorMap[colorName]}`}>
