  ...
  return (
    <div className={`inline-flex justify-end items-center gap-4 ${className}`}>
      <div className="py-1 rounded-3xl flex justify-center items-center gap-2.5">
        ...
        <Link to={''} className={'hover:underline underline-offset-4'}><strong>김글빗</strong> 님 환영합니다.</Link>
      </div>
      <button type={"button"} className={'hidden lg:flex justify-center items-center p-2 hover:bg-blue-50 rounded-xl'}>
